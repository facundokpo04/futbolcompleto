;( function( window, $, undefined ) {
    ...
    window.acf_relationship_create = {
        ...
        /**
         * Get Post Type label given its name
         *
         * @param post_type
         * @returns {*}
         */
        get_post_type_label: function( post_type ) {
            if( typeof window.acf_relationship_create_field == 'undefined' ) return '';
            if( typeof window.acf_relationship_create_field['post_types_labels'] == 'undefined' ) return '';
            if( typeof window.acf_relationship_create_field['post_types_labels'][post_type] == 'undefined' ) return '';
            return window.acf_relationship_create_field['post_types_labels'][post_type];
        }
    };
} )( window, jQuery );